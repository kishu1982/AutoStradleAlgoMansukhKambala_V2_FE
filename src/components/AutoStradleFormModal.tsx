...
export function AutoStradleFormModal({
  ...
  useEffect(() => {
    if (isOpen) {
      if (initialData) {
        ...
        if (
          data.ce_amount_multiplier !== undefined &&
          data.ceAmountMultiplier === undefined
        ) {
          data.ceAmountMultiplier = data.ce_amount_multiplier;
        }
        if (
          data.pe_amount_multiplier !== undefined &&
          data.peAmountMultiplier === undefined
        ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { _id, createdAt, updatedAt, __v, ltp, ...pureData } =
        formData as any;
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Configure automated straddle execution parameters
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="SELL" className="bg-[#0a0a0a]">
                    SELL (Short)
                  </option>
                  <option value="BUY" className="bg-[#0a0a0a]">
                    BUY (Long)
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="INTRADAY" className="bg-[#0a0a0a]">
                    INTRADAY
                  </option>
                  <option value="NORMAL" className="bg-[#0a0a0a]">
                    NORMAL
                  </option>
                  <option value="DELIVERY" className="bg-[#0a0a0a]">
                    DELIVERY
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      quantityLots: parseInt(e.target.value) || 1,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      amountForLotCalEachLeg: parseInt(e.target.value) || 0,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      profitBookingPercentage: parseFloat(e.target.value) || 0,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      ceAmountMultiplier: parseFloat(e.target.value) || 0,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      peAmountMultiplier: parseFloat(e.target.value) || 0,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      exitRatio: parseFloat(e.target.value) || 0,
                    })
                  }
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {formData.legsData?.map((leg, index) => (
                <div
                  key={index}
                  className="relative group rounded-3xl bg-white/5 border border-white/10 p-6 hover:border-blue-500/30 transition-all duration-300"
                >
                  <button
                    type="button"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        value={leg.exch}
                        onChange={(e) =>
                          updateLeg(index, "exch", e.target.value)
                        }
                      >
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateLeg(index, "instrument", e.target.value)
                        }
                      >
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        value={leg.side}
                        onChange={(e) =>
                          updateLeg(index, "side", e.target.value)
                        }
                      >
                    ...
                    <div className="col-span-2 space-y-1">
                      <label className="text-[10px] uppercase font-bold text-gray-500 tracking-wider">
                        Expiry (type to filter)
                      </label>
                      <ExpirySearch
                        required
                        value={leg.expiry}
                        onChange={(expiry) =>
                          updateLeg(index, "expiry", expiry)
                        }
